...
| Score : 0.125 |
 ...
 ![Table 10: Example trajectories for Webshop predicted by Act and \model . Compared to Act , \model uses reasoning to find products that satisfy all target attributes.]() [[TABLE_0]] 