...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-9g#$7v#bx*osg7l$cjjvl+e0!i&z(#sn)-4&q(#yjwzo1bo+df')
...
MIDDLEWARE = [
    # CorsMiddleware must be before CommonMiddleware (and ideally first overall).
